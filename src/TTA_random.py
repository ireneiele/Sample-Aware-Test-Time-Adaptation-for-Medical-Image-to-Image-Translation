...
thresholdes = {'denoising':{80: 0.0024, 85: 0.0028, 90: 0.0033, 95: 0.0064, 98: 0.011},'brats':{80: 0.0009, 85: 0.0010, 90: 0.0010, 95: 0.0012, 98: 0.0014}}
...
def opt_ANet(adaptors, opt, task_model, rec_models=None, stable=False, model_type='AENet', AE=None, return_layers=None):
    ...
    for j, batch in tqdm(enumerate(dataset.dataloader)):  # arriva il campione di test
        ...
        print(f'img name: {img_path_task_model}', f'loss task model: {rec_loss}')
        ...
        if rec_loss > thr:
            ...
            print('configurazione scelta:', used_comb)

...
def opt_ANet(adaptors, opt, task_model, rec_models=None, stable=False, model_type='AENet', AE=None, return_layers=None):
    ...
    # Lista per contenere tutte le combinazioni
    
    tutte_combinazioni = []
    # Genera combinazioni di tutte le lunghezze
    for r in range(1, len(indexs) + 1):
        tutte_combinazioni.extend(combinations(indexs, r))  # tutte le 128 combinazioni possibili
    #tutte_combinazioni = [[0,1,2,3,4,5,6]] # esperimento metodo competitor
